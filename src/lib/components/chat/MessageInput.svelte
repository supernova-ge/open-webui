							...
							<div class=" flex">
								...
								{#if $settings?.richTextInput ?? true}
									<div
										...
										class="scrollbar-hidden text-left bg-gray-50 dark:bg-gray-850 dark:text-gray-100 outline-none w-full py-2.5 px-1 rounded-3xl resize-none h-[48px] overflow-auto"
									>
										<RichTextInput
